...
const Login = () => {
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      {/* Background Image */}
      <img src={assets.bgImage} alt="login cover" className="absolute top-0 left-0 -z-1 w-full h-full object-cover" />
      ...
      <div className="flex flex-col flex-1 items-start justify-between p-6 md:p-10 lg:pl-40">
        ...
        <div>
          <div className="flex items-center gap-3 mb-4 max-md:mt-10">
            <img src={assets.group_users} alt="avatars" className="h-8 md:h-10" />
            <div>
              <div className="flex">
